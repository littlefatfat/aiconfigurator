...
def test_emulation_accuracy():
    ...
    real_benchmark_data = list(filter(lambda x: x["max_concurrency"] < 10, real_benchmark_data))
    ...
    for real_metrics in real_benchmark_data:
        ...
        min_inlen = real_metrics["random_input_len"] * real_metrics["random_range_ratio"]
        max_outlen = real_metrics["random_output_len"]
        min_outlen = real_metrics["random_output_len"] * real_metrics["random_range_ratio"]
