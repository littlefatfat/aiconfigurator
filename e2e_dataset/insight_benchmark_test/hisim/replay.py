...
def validate_hicache_replay(model_path: str, data_dir: Path, case_list=["no_cache", "l1"]) -> list[dict]:
    data_path_list = []
    for case_name in case_list:
        data_path_list.append(f"{data_dir / f'{case_name}.schedule_batch.jsonl'!s}")
        ...
        result.append(
            {
                ...
                "mape_mean_ttft_ms": (sim_metrics["mean_ttft_ms"] - real_metrics["mean_ttft_ms"])
