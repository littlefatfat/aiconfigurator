...
class SGLangSimulatorRunner:
    def __init__(self, server_args: ServerArgs):
        self._runner: SGLangSimulatorBenchmarkRunner = SGLangSimulatorBenchmarkRunner(server_args)
    ...
    def benchmark(
        ...
        assert dataset_args is not None, "Current simulation support `dataset_args` only."
