...
from insight_benchmark.step_benchmark import sglang_hook, transformer_hook, trtllm_hook
...
@pytest.mark.skipif(True, reason="Hook is invalid in pytest environment.")
@pytest.mark.skipif(check_framework("tensorrt_llm"), reason="tensorrt_llm is not installed")
