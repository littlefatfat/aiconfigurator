...
# ============================================================================
SGLANG_LAUNCH_CMD = """
python3 /host/aiconfigurator/test_aic/shared.nv.collector/sglang_launch_server.py \
...
# ============================================================================
# 估算校正系数（来自 run_aic_expand_csv.py 中的 mry debug 参数）
# ============================================================================
DECODE_CORRECTION_FACTOR = 1.02
PREFILL_CORRECTION_FACTOR = 1.02040816  # ≈ 1/0.98
