...
def main():
    ...
    ap.add_argument("--model", type=str, default="/models/Qwen3-235B-A22B-Instruct-2507-FP8")
    ap.add_argument("--tp-size", type=int, default=8)
    ap.add_argument("--ep-size", type=int, default=8)
    ap.add_argument("--iters", type=int, default=3, help="Profile 迭代次数 (default: 3)")
    args = ap.parse_args()
    ...
    for i in range(args.iters):
        ...
        outputs = llm.generate(
            input_ids=profile_prompts, sampling_params={"temperature": 0, "top_p": 1, "max_new_tokens": 4}
        )
